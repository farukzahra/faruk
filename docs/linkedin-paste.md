# LinkedIn paste pack — Faruk Zahra

Generated from the live resume content (Phase A).  
LinkedIn **does not** expose a personal API to update About / Experience / Skills with a simple token — paste manually.
