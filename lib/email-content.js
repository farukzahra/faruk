...
My name is Faruk Zahra, and I am a software engineer with 20+ years of experience in Java, Spring Boot, RESTful APIs, cloud services, and software architecture, currently focused on production-oriented Generative AI solutions (LLMs, RAG, and AI agents).

I am currently exploring new professional opportunities and would like to apply for a position at your company. I believe my technical background, experience working with international teams, and ability to deliver reliable, scalable software solutions could be a strong fit for your team.
...
Meu nome é Faruk Zahra e sou engenheiro de software com mais de 20 anos de experiência em Java, Spring Boot, APIs REST, serviços em nuvem e arquitetura de software, atualmente focado em soluções de IA generativa orientadas a produção (LLMs, RAG e agentes de IA).

Atualmente estou em busca de novas oportunidades profissionais e gostaria de me candidatar a uma vaga na sua empresa. Acredito que minha formação técnica, experiência com equipes internacionais e capacidade de entregar soluções confiáveis e escaláveis podem ser um forte diferencial para a equipe.
